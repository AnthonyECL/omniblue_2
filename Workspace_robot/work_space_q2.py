...
if __name__ == '__main__':
	...
	for i in np.arange(joint_limits[0], joint_limits[1], step):   
		joints = [0.0, i, 1.57, 0.0, 0.0]
		Model_direct(0.0, i, 1.57, 0.0, 0.0, 0.0)
	...
	ax.set_ylabel('Y(m)')
	ax.set_zlabel('Z(m)')
	ax.set_title('Espace de travail de l\'articulation q2')

	data_q2 = pd.read_csv("opti_q2.csv")
	ax.set_xlim([-1.5, 0])
