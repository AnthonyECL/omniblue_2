...
if __name__ == '__main__':
	...
	# Génération des coordonnées pour chaque point suivant l'axe d'articulation q1 dans l'espace de travail
	for i in np.arange(joint_limits[0], joint_limits[1], step):   
		joints = [i, -1.57, 1.57, 0.0, 0.0]
		Model_direct(i, -1.57, 1.57, 0.0, 0.0, 0.0)
	...
	ax.set_ylabel('Y(m)')
	ax.set_zlabel('Z(m)')
	ax.set_title('Espace de travail de l\'articulation q1')
	data_q1 = pd.read_csv("/home/cristal/NIRYO/niryo/Files_csv/opti_q1.csv")
